<?
// define('C_REST_CLIENT_ID','your_application_id');//Application ID
// define('C_REST_CLIENT_SECRET','your_application_key');//Application key
// or
define('C_REST_WEB_HOOK_URL','your_webhook');//url on creat Webhook
